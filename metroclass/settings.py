"""
Django settings for metroclass project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'courses.context_processors.navigation_courses',
            ],
        },
    },
]

WSGI_APPLICATION = 'metroclass.wsgi.application'
